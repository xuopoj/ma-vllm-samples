#!/usr/bin/env python3
"""Simple smoke test for the A3 1p1x2d PD-disaggregated Qwen3.5-397B-A17B deployment.
...
Usage:
  python3 smoke_test.py --proxy-url   http://<proxy_ip>:8080 [--model qwen3.5] ...
  python3 smoke_test.py --prefill-url http://<p_ip>:7100 \\
                        --decode-url  http://<d_ip>:7100  [--model qwen3.5] ...
"""
...
"""
    ...
    parser.add_argument("--model", default="qwen3.5", help="Served model name (--served-model-name in run_*.sh)")
