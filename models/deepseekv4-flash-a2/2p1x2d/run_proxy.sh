...
#   prefiller 0 -> AISHIPBOX_ADDRS[0]:7100   (DP=8 producer engine, engine_id=0)
#   prefiller 1 -> AISHIPBOX_ADDRS[1]:7100   (DP=8 producer engine, engine_id=1)
#   decoder   0 -> AISHIPBOX_ADDRS[2]:7100   (DP=16 consumer cluster, master/rank-2)
#
...
prefiller0_ip=$1
prefiller1_ip=$2
decoder0_ip=$3   # decode DP=16 master (rank 2); the only decode API endpoint
