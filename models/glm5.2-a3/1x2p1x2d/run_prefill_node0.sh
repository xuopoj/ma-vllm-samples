...
# (16 NPUs, TP=16) on API port 9081, dp-rank 0. The prefill engine spans 2 nodes
# (this master + prefill node 1); node 1 rendezvous with this node's IP.
# kv_port=30000, engine_id=0. Guide command mirrored below:
