#!/usr/bin/env python3
"""Simple smoke test for the A3 1x2P1x2D PD-disaggregated GLM-5.1 deployment.
...
Usage:
  python3 smoke_test.py --proxy-url   http://<proxy_ip>:8080 [--model glm-5] ...
  python3 smoke_test.py --prefill-url http://<p_ip>:9081 \\
                        --decode-url  http://<d_ip>:9900  [--model glm-5] ...
"""
