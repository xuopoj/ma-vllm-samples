#!/bin/sh
# GLM-5.1-w8a8 entry script on 2x Atlas 800 A3 (16 NPU/node, 32 total).
...
#
# Derived from the official GLM-5 tutorial (Multi-Node A3, w8a8). The page
# covers GLM-5 and GLM-5.1 with the same commands; this serves GLM-5.1-w8a8:
