#!/bin/bash
# Decode node 3 (AISHIPBOX_NODE_RANK=5): decode-DP worker, hosts dp-ranks 12..15 of DP=16, TP=4.
...
echo "[run] role=DECODE_3 nic=$nic_name local=$local_ip decode_master=$decode_master_ip"
