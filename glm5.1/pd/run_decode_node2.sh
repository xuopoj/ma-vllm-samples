#!/bin/bash
# Decode node 2 (AISHIPBOX_NODE_RANK=4): decode-DP worker, hosts dp-ranks 8..11 of DP=16, TP=4.
...
echo "[run] role=DECODE_2 nic=$nic_name local=$local_ip decode_master=$decode_master_ip"
