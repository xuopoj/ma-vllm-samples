...
| `3p1d` | 3 个单节点 P + 1 个单节点 D(prefill 重) | 4 |
| `1p3d` | 1 个单节点 P + 3 个单节点 D(decode 重) | 4 |
...
| `models/deepseekv4-flash-a3/2p2d`   | `v0.21.0rc1-a3` | ⚠ untested (derived from 1p1d) |
| `models/deepseekv4-flash-a3/3p1d`   | `v0.21.0rc1-a3` | ⚠ untested (derived from 1p1d) |
| `models/deepseekv4-flash-a3/1p3d`   | `v0.21.0rc1-a3` | ⚠ untested (derived from 1p1d) |
...
| `models/glm5.1-a3/1x2p1x2d`         | `TODO`          | ⚠ untested (derived from 1x2p1x4d) |
